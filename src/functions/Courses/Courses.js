...
export const createCoursesFun = async (values) => {
  return await axios.post(
    `${process.env.REACT_APP_API_URL_COFFEE}/api/auth/CoursesFun`,
    values,
    {
        headers: {
...
export const removeCoursesFun = async (_id) => {
  return await axios.delete(
    `${process.env.REACT_APP_API_URL_COFFEE}/api/auth/remove/CoursesFun/${_id}`
  );
};
...
export const updateCoursesFun = async (_id, values) => {
  return await axios.put(
    `${process.env.REACT_APP_API_URL_COFFEE}/api/auth/update/CoursesFun/${_id}`,
    values,
    {
        headers: {
          'Content-Type': 'multipart/form-data'
...
export const getCoursesFun = async (_id) => {
  return await axios.get(
    `${process.env.REACT_APP_API_URL_COFFEE}/api/auth/get/CoursesFun/${_id}`
  );
};
