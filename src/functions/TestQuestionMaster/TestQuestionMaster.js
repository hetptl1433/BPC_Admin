...
export const createTestQuestionMaster = async (values) => {
  return await axios.post(
    `${process.env.REACT_APP_API_URL_BPC}/api/auth/location/create/TestQuestionMaster`,
    values
  );
};
...
export const listTestQuestionMaster = async () => {
  return await axios.get(
    `${process.env.REACT_APP_API_URL_BPC}/api/auth/location/TestQuestionMaster`
  );
};

export const removeTestQuestionMaster = async (_id) => {
  return await axios.delete(
    `${process.env.REACT_APP_API_URL_BPC}/api/auth/location/TestQuestionMaster/${_id}`
  );
};
