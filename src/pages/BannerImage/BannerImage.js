...
import {
  ...
  removeBannerImages,
  updateBannerImages,
} from "../../functions/BannerImage/BannerImage";
const initialState = {
  Title: "",
  Text: "",
...
const BannerImages = () => {
  ...
  const { Title, Text, bannerImage, IsActive } = values;
  ...
  const fetchCategories = async () => {
    ...
    await axios
      .post(
        `${process.env.REACT_APP_API_URL_BPC}/api/auth/list-by-params/banner-images1`,
        {
          skip: skip,
          per_page: perPage,
          sorton: column,
