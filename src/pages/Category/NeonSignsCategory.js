...
const NeonSignsCategoryMaster = () => {
  ...
  const handleClick = (e) => {
    ...
    if (Object.keys(errors).length === 0) {
        createNeonSignsCategory(values)
        .then((res) => {
          setmodal_list(!modal_list);
            setValues(initialState);
            fetchCategories();
  ...
  const handleDelete = (e) => {
    e.preventDefault();
    removeNeonSignsCategory(remove_id)
      .then((res) => {
        setmodal_delete(!modal_delete);
        fetchCategories();
      })
  ...
  const handleUpdate = (e) => {
    ...
    if (Object.keys(errors).length === 0) {
      updateNeonSignsCategory(_id, values)
        .then((res) => {
          setmodal_edit(!modal_edit);
          fetchCategories();
        })
  ...
  document.title = "Neon Signs Category | Neon 11";
                ...
                <CardHeader>
                  <Row className="g-4 mb-1">
                    <Col className="col-sm" sm={6} lg={4} md={6}>
                      <h2 className="card-title mb-0 fs-4 mt-2">Neon Signs Category</h2>
                    </Col>
...
export default NeonSignsCategoryMaster;
