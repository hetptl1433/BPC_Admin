...
import { createIndustry, getIndustry, removeIndustry, updateIndustry } from "../../functions/Industry/Industry";
...
const Industry = () => {
  ...
  const { Name, Email, Address, IsActive } = values;
  ...
  const fetchCategories = async () => {
    ...
    await axios
      .post(
        `${process.env.REACT_APP_API_URL_BPC}/api/auth/list-by-params/Industry`,
        {
          skip: skip,
          per_page: perPage,
          sorton: column,
