...
import { createExtraBooking, getExtraBooking, removeExtraBooking, updateExtraBooking } from "../../functions/ExtraBooking/ExtraBooking";
...
const ExtraBooking = () => {
  ...
  const { Name,Price, SortOrder, IsActive } = values;
  ...
  document.title = "Extra Booking | BPC";
