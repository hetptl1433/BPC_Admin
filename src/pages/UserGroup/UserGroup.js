...
import { createUserGroup, getUserGroup, removeUserGroup, updateUserGroup } from "../../functions/UserGroup/UserGroup";
...
const UserGroup = () => {
  ...
  const fetchCategories = async () => {
    ...
    await axios
      .post(
        `${process.env.REACT_APP_API_URL_BPC}/api/auth/list-by-params/UserGroupMaster`,
        {
          skip: skip,
          per_page: perPage,
          sorton: column,
