...
//   };
  ...
  document.title = "NeonGo Products | Neon11";
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <BreadCrumb
            maintitle="NeonGo Products"
            title="NeonGo Products"
            pageTitle="Products"
          />
